...
import {Home,FolderKanban,Images,WandSparkles,Projector,Calculator,Boxes,Settings,Menu,Search,LogOut,X,Globe2,Clock3,ClipboardList,PackageCheck,WalletCards,NotebookPen} from 'lucide-react'
...
export default function Shell(){
 ...
 const items=[
  ...
  ['/notebook',NotebookPen,t('notebook')],
